...
export function Clubs() {
    ...
    return (
        <div className='bg-black p-5 h-[85.5vh]'>
            <h1 className=' font-black_ops_one text-[#f9d112] text-center text-4xl '>CLUBS</h1>
            <div className='w-full px-10 h-full relative flex flex-col divide-y-2 divide-[#f9d112]'>
                <div>
                    <div className="grid max-w-screen px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                        <div className="mr-auto place-self-center lg:col-span-7">
                            <h1 className="max-w-2xl mb-4 text-4xl tracking-tight leading-none md:text-5xl xl:text-6xl text-white font-black_ops_one">DYNAMICS 101 MMA MADURAVOYAL</h1>
                        ...
                        <div className='flex'>
                            <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7773.197336000098!2d80.15496599357908!3d13.061198600000006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5261fcae338c71%3A0x79984c292d0fba1c!2sDynamics%20101%20MMA!5e0!3m2!1sen!2sin!4v1746469570535!5m2!1sen!2sin" width="600" height="450" className='mt-3 sm:w-[450px] sm:h-[250px] w-[200px] h-[200px] rounded-xl border-0' loading="lazy"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
